...
describe('ProviderNotificationController', function() {
	...
	before(function(done) {
		Provider.create({email: "provider_test_notification@gmail.com", password: "14491992", firstName: "Tombook", lastName: "Joebook", abn: '3286392734f', service: ['mowing', 'leaf_removal', 'yard_cleaning'], postcode: 3083, address: '16 Keats Avenue, Kingsbury', location: { type: 'Point', coordinates: [145.036478, -37.718564]}}, function(err, provider) {
		...
		Admin.create({email: "admin_test_notification1@gmail.com", password: "14491992"}, function(err, admin) {
