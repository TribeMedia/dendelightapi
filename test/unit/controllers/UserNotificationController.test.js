...
describe('UserNotificationController', function() {
	...
	before(function(done) {
		User.create({email: "user_test_notification@gmail.com", password: "14491992"}, function(err, user) {
			userId = user.id;
		...
		Admin.create({email: "admin_test_notification@gmail.com", password: "14491992"}, function(err, admin) {
