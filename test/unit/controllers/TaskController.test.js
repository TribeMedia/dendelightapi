...
describe('BookingController', function() {
	...
	before(function(done) {
		Provider.create({email: "provider_test_task@gmail.com", password: "14491992", firstName: "Tombook", lastName: "Joebook", abn: '3086380734f', service: ['mowing', 'leaf_removal', 'yard_cleaning'], postcode: 3083, address: '16 Keats Avenue, Kingsbury', location: { type: 'Point', coordinates: [145.036478, -37.718564]}}, function(err, provider) {
		...
		User.create({email: "user_test_task@gmail.com", password: "14491992"}, function(err, user) {
			userId = user.id;
		...
		Admin.create({email: "admin_test_task@gmail.com", password: "14491992"}, function(err, admin) {
	...
	describe('boostrap task', function() {
		it('should have  json response', function(done) {
			request(sails.hooks.http.app)
				...
				.send({services: ['mowing', 'leaf_removal'], address: '16 Keats Ave, Kingsbury', estimatedSize: 'medium', bookTime: 1559977804187, estimatedDuration: 1440000, treeNumber: 'three trees', providerId: providerId, wage: 30})
				.expect(201)
